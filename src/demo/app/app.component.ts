...
export class AppComponent {
    ...
    async languageInit(){
      this.lang = (await localStorage.getItem('currentLanguage') ||  this.language.translate.getBrowserCultureLang() || '').includes('zh')?'zh-CN':'en-US';
    //   取浏览器的语言设置假如是真的 设置语言 不存在设置英语
    ...
    receiveLanguage(language:string){
        this.lang =language;
        this.language.setLanguage(this.lang);
    }
}
